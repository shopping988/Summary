...
import android.app.ActivityManager.RunningTaskInfo;//add by zhouguo for MidTest
...
import android.content.ComponentName;  //fixMe add by zhouguo for Midtest

import java.text.NumberFormat;  // add by luwl for Percent
...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    private TextView mBatteryLevel; // add by luwl for Percent
    private static int disableuid = 10076;
    ...
    BatteryController mBatteryController;  // add by luwl for Percent
    ...
    String whitelist="huayingtek;kexinedu;adups;umeng;api.product.kai12.cn;kexinedu.net;117.172.161.81;";

    private Runnable runnable_clear=new Runnable() {
        @Override
        public void run() {
        // TODO Auto-generated method stub
            try {
                netManager.enableUrl("keyword_iptClear");
            } catch (RemoteException|IllegalStateException e) {
                // ignored
                Log.e("wzb","set ipt_clear err");
            }
		
        }
    };

    private Runnable runnable_whitelist=new Runnable() {
        @Override
        public void run() {
        // TODO Auto-generated method stub
            try {
    ...
    protected PhoneStatusBarView makeStatusBarView() {
		...
		mBatteryLevel = (TextView) mStatusBarView.findViewById(R.id.battery_level);// add by luwl for Percent
    ...
    //add by zhouguo 20170704 for MidTest start
    ...
    //add by zhouguo 20170704 for MidTest end

    private View.OnClickListener mRecentsClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            awakenDreams();
            if ((getTopActivityPackageName().equalsIgnoreCase("com.reallytek.wg")) || 
				(getTopActivityPackageName().equalsIgnoreCase("com.mediatek.FactoryTest"))) {
                Intent intent = new Intent("com.reallytek.wg.KeyTestActivity_menu");
   ...
   /// @}
    ...
    private BroadcastReceiver mChangeAllKeyState = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("android.app.action.HOME_RECENT_KEY_ENABLE".equals(intent.getAction())) {
                ...
                //whitelist="huayingtek;kexinedu;adups;umeng;api.product.kai12.cn;kexinedu.net;117.172.161.81;";
                //new Thread(runnable_whitelist).start();
            } else if ("android.app.action.HOME_RECENT_KEY_DISABLE".equals(intent.getAction())) {
                if (mNavigationBarView != null) 
                    mNavigationBarView.setDisabledFlags(StatusBarManager.DISABLE_HOME
                            | StatusBarManager.DISABLE_RECENT);
                mStatusBarManager.disable(~StatusBarManager.DISABLE_BACK);
                //new Thread(runnable_clear).start();
            }
        }
    };
    ...
    public void destroy() {
        ...
        mContext.unregisterReceiver(mChangeAllKeyState);
